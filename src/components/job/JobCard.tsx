...
//   // Prefer a direct status if present.
//   let raw =
//     shift?.status ??
//     shift?.shiftStatus ??
//     shift?.shiftPaymentStatus ?? // e.g. "Paid"
//     shift?.contractorInvoiceStatus ?? // sometimes "waiting" -> treat as "Unsubmitted"
...
//   // Normalize a few common variants. Adjust these as your API dictates.
//   if (
...
//   // Try direct fields, then nested shift/event fields
//   const start =
//     shift?.startTime ||
...
//   // Prefer real venue/address, fallback to city or dash
//   const venue =
...
//     ? "border-red-400 border-2  text-black-600"
//     : "border-green-500 border-2 text-black-600";

//   // Scheduled time (e.g., 08:00–19:00)
...
//         {/* Row 2: Location + Right-side info */}
